          ...
          {rows.map((row, i) => (
            <tr
              ...
              className={`border-b border-slate-200 ${
                  row.highlight ? 'bg-gray-50 font-semibold' : 'hover:bg-gray-50'
                }`}
            >
              <td className="py-2 px-4 text-slate-700">{row.label}</td>
              <td className="py-2 px-3 text-right font-mono text-slate-600">{fmt(row.control)}</td>
